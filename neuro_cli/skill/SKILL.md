...
This file is the canonical Neuro CLI skill contract for release-1.1.8 and later.
The project-shared `.github/skills/neuro-cli/SKILL.md` entry remains only as the
Agent discovery adapter and must point back to this package.
...
1. Keep CLI stdout and automation evidence JSON-readable. Use `--output json`
	or the wrapper at `../scripts/invoke_neuro_cli.py`.
...
6. Ask the CLI for `workflow plan <name>` before running build, preflight,
	smoke, deploy, callback, memory-evidence, or release-closure workflows.
...
- [Linux setup reference](./references/setup-linux.md)
- [Windows setup reference](./references/setup-windows.md)
- [Discovery and control reference](./references/discovery-and-control.md)
