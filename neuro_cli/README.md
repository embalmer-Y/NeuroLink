...
Current release target: `1.2.2`. For release-1.2.2, Neuro CLI remains the stable Unit tool/control surface consumed by the real-LLM `neurolink_core` Core track.
...
## Agent-facing release-1.2.2 surfaces
