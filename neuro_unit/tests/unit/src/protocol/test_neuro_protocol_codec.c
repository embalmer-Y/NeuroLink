...
{
	const uint8_t payload[] = { 0xa8, 0x00, 0x02, 0x01, 0x02, 0x18, 0x1e,
		0x6d, 0x61, 0x70, 0x70, 0x2f, 0x61, 0x2f, 0x63, 0x6f, 0x6e,
		0x74, 0x72, 0x6f, 0x6c, 0x18, 0x20, 0x19, 0xea, 0x60, 0x18,
		0x34, 0xa2, 0x66, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x64,
		0x72, 0x65, 0x61, 0x64, 0x65, 0x76, 0x61, 0x6c, 0x75, 0x65,
		0xf5, 0x18, 0x50, 0xf5, 0x18, 0x51, 0x03, 0x18, 0x52, 0x64,
		0x74, 0x69, 0x63, 0x6b };
	...
	zassert_equal(strcmp(fields.event_name, "tick"), 0,
		"event_name should decode");
	zassert_equal(strcmp(fields.args_json,
			      "{\"action\":\"read\",\"value\":true}"),
		0, "args object should decode to JSON for app dispatch");
}
